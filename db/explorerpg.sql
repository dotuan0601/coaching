...
(
  ...
  read_set varchar(1000) default NULL,
  write_set varchar(1000) default NULL,
  function_args text default NULL,
  block_hash character varying(256) DEFAULT NULL,
  channel_genesis_hash character varying(256) DEFAULT NULL,
...
-- ----------------------------
--  Table structure for `transactions_loyalty`
-- ----------------------------

DROP TABLE IF EXISTS transactions_loyalty;
...
(
  ...
  time_off_chain BIGINT DEFAULT NULL,
  description varchar(800) DEFAULT NULL,
  account_balance_before integer DEFAULT NULL,
  account_balance_after integer DEFAULT NULL,
  receiver_balance_before integer DEFAULT NULL,
  receiver_balance_after integer DEFAULT NULL,
  time_on_chain BIGINT DEFAULT NULL,
  account_nonce integer DEFAULT NULL,
  debit_nonce integer DEFAULT NULL,
  receiver_nonce integer DEFAULT NULL,
  receiver_debit_nonce integer DEFAULT NULL,
  account_chaincode_hash varchar(800) DEFAULT NULL,
  receiver_chaincode_hash varchar(800) DEFAULT NULL,
  account_total_point_before integer DEFAULT NULL,
  account_total_point_after integer DEFAULT NULL,
  receiver_total_point_before integer DEFAULT NULL,
  receiver_total_point_after integer DEFAULT NULL,
  account_add_point integer DEFAULT NULL,
  receiver_add_point integer DEFAULT NULL,
  txn_hash varchar(255) DEFAULT NULL,
  trace_no varchar(255) DEFAULT NULL,
  receiver_total_balance_before integer DEFAULT NULL,
  receiver_total_balance_after integer DEFAULT NULL,
  account_signature varchar(800) DEFAULT NULL,
  receiver_signature varchar(800) DEFAULT NULL,
  account_last_channel varchar(255) DEFAULT NULL,
  receiver_last_channel varchar(255) DEFAULT NULL,
  signer varchar(800) DEFAULT NULL,
...
ALTER table transactions_loyalty owner to :user;
...
DROP INDEX IF EXISTS transaction_trace_number_idx;
CREATE INDEX ON Transactions
(trace_number);
...
DROP INDEX IF EXISTS transaction_trace_no_idx;
CREATE INDEX ON transactions_loyalty
(trace_no);

DROP INDEX IF EXISTS transaction_loyalty_createdt_idx;
CREATE INDEX ON transactions_loyalty
(createdt);

DROP INDEX IF EXISTS transaction_loyalty_block_id_idx;
CREATE INDEX ON transactions_loyalty
(block_id);

DROP INDEX IF EXISTS transaction_loyalty_chaincode_proposal_input_idx;
CREATE INDEX ON transactions_loyalty
((md5
(chaincode_proposal_input)));
